...
import ImportadorFotos from "./ImportadorFotos";
...
export default function ImportadorClient() {
  const [tab, setTab] = useState<"catalogo" | "colaboradores" | "usuarios" | "evaluaciones" | "hrcorp" | "estudios" | "cursos" | "competencias" | "desempeno" | "eal" | "picd" | "calcular_eip" | "sucesion" | "experiencia_externa" | "fotos">("catalogo");
    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex gap-1 border-b border-gray-200">
        {([
          ...
          { id: "fotos",                 label: "Fotos de Empleados" },
        ] as const).map((t) => (
          <button
            key={t.id}
            onClick={() => setTab(t.id)}
